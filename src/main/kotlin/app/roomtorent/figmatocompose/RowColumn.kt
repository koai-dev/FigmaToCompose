...
fun autoLayoutToComposeRowColumn(
                ...
                makeCompose(child) {
                    if (child is LayoutMixin) {
                        ...
                        when (child.layoutAlign) {
                            ...
                            "CENTER" ->
                                gravity(
                                    ModifierChain.AlignmentOption.CenterHorizontally,
                                ) // Deprecated in figma but still used in designs for now
                            "INHERIT" -> {}
                ...
                makeCompose(child) {
                    ...
                    if (child is LayoutMixin) {
                        ...
                        when (child.layoutAlign) {
                            ...
                            "CENTER" ->
                                gravity(
                                    ModifierChain.AlignmentOption.CenterVertically,
                                ) // Deprecated in figma but still used in designs for now
                            "INHERIT" -> {}
                            else -> throw Exception("unrecognized LayoutAlign ${child.layoutAlign}")
                        }
