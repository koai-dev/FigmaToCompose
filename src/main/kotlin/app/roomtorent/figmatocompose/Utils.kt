...
fun String.args(
    ...
    escapeCharacters: Boolean = false,
...
fun RGBA.toComposeColor(opacityOverride: Float? = null) =
    "Color(${this.r.roundedForHuman()}f, ${this.g.roundedForHuman()}f, ${this.b.roundedForHuman()}f, ${opacityOverride ?: this.a.roundedForHuman()}f)"
